...
public class RecipeController implements Initializable {
    ...
    public ChoiceBox<BakedGood> rChoiceBoxPickGood;
    ...
    public void deleteRecipe(MouseEvent mouseEvent) {
        int selectedr = rListView.getSelectionModel().getSelectedIndex();
        BakedGood.bakedGood.recipeList.delete(selectedr);
        updateRListView(selectedGood);
